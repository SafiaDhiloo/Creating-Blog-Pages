    ...
    return (
        <div>
            ...
            <div className="p-6">
                ...
                <p className="font-medium text-gray-700 text-xl p-6">Most candidates think interviews are like a game of chance that putting your best foot forward requires a bit of luck,or that the interviewers have all of the control.The hiring manager will either like you or they won't,right? <br />But crossing your fingers and hoping you get asked the “right” questions or assuming you can get by on charm or charisma alone isn't a great way to prepare for the interview process.Instead,there are some simple ways that you can improve your interviewing skills and land the job with just a little effort and preparation. </p>
