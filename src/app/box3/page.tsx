        ...
        <div>
            ...
            <div className="p-6">
                ...
                <p className="font-medium text-gray-700 text-xl p-2">
                    Good training is essential for any profession.And to be a computer programmer,it's really important to have a well-crafted foundation.For this, you need to choose the right programming school to give you these basics,which will be of paramount importance.<br />Furthermore,once you've acquired the necessary knowledge through the training,it's very likely that throughout the process you will acquire many more of the strengths.
                </p>
                <h2 className="font-bold text-blue-600 text-3xl p-2">Logic and knowing how to plan correctly</h2>
                <p className="font-medium text-gray-700 text-xl p-2">The work of a developer is based on projects,which are ordered and organised into small tasks.Having organisational and logical qualities is one of the most important characteristics of a good programmer.It's very important that,when you choose a school for programming,its methodology is project-orientated:if you learn to organise your work into small projects from the very beginning,you're going to go far.</p>
